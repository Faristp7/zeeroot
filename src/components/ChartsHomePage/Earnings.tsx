      ...
      <div className="grid grid-cols-2">
        <div className="mb-4 text-center dark:text-gray-400 font-semibold border-r dark:border-gray-700">
          <h5>This Month's Earnings</h5>
           <h1 className="text-2xl sm:text-5xl font-extrabold"><span className="text-yellow-500 dark:text-gray-400">$</span>2,500</h1>
        ...
        <div className="flex flex-col text-center dark:text-gray-400">
          ...
          <h1 className="text-2xl sm:text-5xl font-extrabold"><span className="text-yellow-500 dark:text-gray-400">$</span>3,000</h1>
